...
class P2JS {
	...
	function print_options() {
		...
		$page_options['prologue_updates'] = 0;
		$page_options['prologue_comments_updates'] = 0;
		...
		$page_options['custom_post_type'] = $p2_custom_post_type;
?>
	<script type="text/javascript" charset="<?php bloginfo('charset'); ?>">
		...
		var styleSheetDir  = "<?php esc_js( bloginfo('stylesheet_directory') ); ?>";
		...
		var customPostType = "<?php echo esc_js( $page_options['custom_post_type'] ); ?>";
		 // ]]>
		</script>
<?php		
	}
