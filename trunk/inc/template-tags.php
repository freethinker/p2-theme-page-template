...
function p2_load_entry() {
	...
	$withcomments = true;
	if ( file_exists( STYLESHEETPATH . '/p2/entry.php' ) )
		require STYLESHEETPATH . '/p2/entry.php';
	else if ( file_exists( TEMPLATEPATH . '/p2/entry.php' ) )
		require TEMPLATEPATH . '/p2/entry.php';
}
